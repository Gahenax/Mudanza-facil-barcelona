        ...
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-6 animate-slide-up delay-200">
            <Button
              variant="cta"
              size="lg"
              className="h-16 px-10 rounded-xl text-lg font-black bg-primary text-white hover:bg-black transition-all hover:scale-105 flex items-center gap-3 uppercase tracking-tight shadow-xl shadow-primary/20"
              asChild
            >
              <a href="#tarifas">
                {h.cta}
